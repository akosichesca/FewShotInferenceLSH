...
parser.add_argument('--dist.distance', type=str, default="euclidean", metavar='DIST',
                    help="distance metric (default: euclidean)")
parser.add_argument('--memsize', type=int, default=256, metavar='MEMSIZE',
                    help="distance metric (default: euclidean)")
parser.add_argument('--ttf', type=int, default=1, metavar='TTF',
                    help="time to forget")
